...
1. FinanceResearchAgent (2024)
   A powerful AI-driven research assistant that automates financial research using LangGraph, Chainlit, and LLMs (Groq/Ollama). Fetches and summarizes the latest financial news, trends, and reports from web sources in real time with conversational interface.
   Technologies: LangGraph, Chainlit, FastAPI, Groq/Ollama LLMs, Docker, Web Search APIs
   GitHub: https://github.com/AnkurDebnath35/FinanceResearchAgent

2. Good Quality End-to-end Hindi TTS using Tacotron2, WaveGlow and Transfer Learning (Aug 2019 – June 2020)
   Designed, develop and test an end-to-end TTS for Hindi in a well-known voice. With only 20 hrs of speech, able to achieve MOS of 4.45
   Technologies: Tacotron2, WaveGlow, Transfer Learning, TTS, Speech Synthesis
   GitHub: https://github.com/AnkurDebnath35/hindi-tts-tacotron2

3. Text-Independent Speaker Identification using Scattering Transform (Jan 2019 – May 2019)
